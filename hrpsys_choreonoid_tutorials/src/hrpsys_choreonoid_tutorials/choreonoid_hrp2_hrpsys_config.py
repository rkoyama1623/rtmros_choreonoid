...
class ChoreonoidJSKHRP2HrpsysConfiguratorOrg(JSKHRP2HrpsysConfigurator):
    def getRTCList (self):
...
class ChoreonoidJSKHRP2HrpsysConfigurator(ChoreonoidJSKHRP2HrpsysConfiguratorOrg):
